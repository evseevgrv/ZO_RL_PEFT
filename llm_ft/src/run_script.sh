...
for learning_rate in 1e-4 5e-4 1e-3 5e-3 1e-2; do
    python run.py --model_name="facebook/opt-1.3b" \
                ...
                --trainer=zo_rl --train_set_seed=1 --lr_scheduler_type=constant --save_steps=1000  \
                --learning_rate=$learning_rate --zo_eps=1e-2 --momentum=0.0 --weight_decay=0 --module_wise_perturbation=False \
                ...
                --k_value=5 --variance=1e-3 --lr_mu=5e-3
done
